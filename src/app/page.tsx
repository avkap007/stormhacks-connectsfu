...
export default function Home() {
  const demoItems: CarouselItem[] = [
    ...
    const categories: Category[] = [
        { id: "tech", label: "Technology", emoji: "💻", href: "/events?category=Technology" },
        { id: "business", label: "Business", emoji: "📈", href: "/events?category=Business" },
        { id: "networking", label: "Networking", emoji: "🤝", href: "/events?category=Networking" },
        { id: "wellness", label: "Health & Wellness", emoji: "🧘", href: "/events?category=Health%20%26%20Wellness" },
        { id: "cultural", label: "Cultural", emoji: "🌏", href: "/events?category=Cultural" },
        { id: "career", label: "Career", emoji: "🧭", href: "/events?category=Career" },
        { id: "environment", label: "Environment", emoji: "🌿", href: "/events?category=Environment" },
      ];
      ...
      const clubs: Club[] = [
        {
          id: "gdsc",
          name: "GDSC SFU",
          tagline: "Empowering students through Google technologies and community.",
          emoji: "💡",
          href: "#",
        },
        {
          id: "design",
          name: "Design Club",
          tagline: "Where creativity meets purpose — learn UI/UX and collaborate.",
          emoji: "🎨",
          href: "#",
        },
        {
          id: "ai",
          name: "AI Society",
          tagline: "Workshops, projects, and talks on AI, ML, and data science.",
          emoji: "🤖",
          href: "#",
        },
        {
          ...
          tagline: "Create, shoot, and share your visual storytelling ideas.",
          emoji: "🎬",
          href: "#",
        },
        {
          ...
          tagline: "Mindfulness, meditation, and stress-relief activities weekly.",
          emoji: "🧘",
          href: "#",
        },
      ];
      ...
      <main className="min-h-screen bg-gradient-to-br from-ceil/10 via-pearly-purple/5 to-dessert-sand/10 pt-16">
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="mt-16 mb-4 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold text-chinese-blue">
              Trending Categories
            </h2>
            <p className="text-gray-600 text-sm sm:text-base mt-1">
              Explore events by theme and find what interests you most.
            </p>
          </div>
